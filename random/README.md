...
- **get_github_user_octocat**: GET request to https://api.github.com/users/octocat
- **get_all_posts**: GET request to https://jsonplaceholder.typicode.com/posts
- **get_post_1**: GET request to https://jsonplaceholder.typicode.com/posts/1
- **random_cat_fact**: GET request to https://catfact.ninja/fact
